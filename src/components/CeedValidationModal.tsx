...
export default function CeedValidationModal({ isOpen, onClose, encounterId }: CeedValidationModalProps) {
  ...
  const [validationMode] = useState<'1' | '2'>('1')
  ...
  const renderExceptionsGrid = (hasExceptions: boolean, exceptions: { edit: any; logType: string; logId: number }[]) => {
    if (hasExceptions) {
      return (
        <Grid.Col span={12}>
